                    ...
                    <br>
                        <form class="form-horizontal row-fluid" action="book.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        ...
                                        $sql="select * from LMS.book order by BookId";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><b><?php echo $avail ?></b></td>
                                        <td><center>
                                            <a href="bookdetails.php?id=<?php echo $bookid; ?>" class="btn btn-light">Details</a>
                                            <a href="edit_book_details.php?id=<?php echo $bookid; ?>" class="btn btn-danger">Edit</a>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
                               </tbody>
